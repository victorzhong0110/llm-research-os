"""Deterministic JSON Schema generation for SecretRef v0alpha1."""
...
from llm_research_os.secrets.models import SECRET_REF_SCHEMA_ID, SecretRef
from llm_research_os.spec.schema import SCHEMA_DIALECT

SCHEMA_ID = SECRET_REF_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = SecretRef.model_json_schema(
        by_alias=True,
        mode="validation",
