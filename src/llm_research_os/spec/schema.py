"""Deterministic JSON Schema generation for the external protocol contract."""
...
SCHEMA_ID = "https://researchos.dev/schemas/research-spec/v0alpha1.schema.json"


def build_schema() -> dict[str, Any]:
    generated = ResearchSpec.model_json_schema(
        by_alias=True,
        mode="validation",
