"""Deterministic JSON Schema generation for BlockManifest v0alpha1."""
...
SCHEMA_ID = "https://researchos.dev/schemas/block-manifest/v0alpha1.schema.json"


def build_schema() -> dict[str, Any]:
    generated = BlockManifest.model_json_schema(
        by_alias=True,
        mode="validation",
