"""Deterministic JSON Schema generation for ProblemReport v0alpha1."""
...
SCHEMA_ID = "https://researchos.dev/schemas/problem-report/v0alpha1.schema.json"


def build_schema() -> dict[str, Any]:
    generated = ProblemReport.model_json_schema(
        by_alias=True,
        mode="serialization",
