"""Deterministic JSON Schema generation for RunCancellationRequest v0alpha1."""
...
SCHEMA_ID = RUN_CANCELLATION_REQUEST_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = RunCancellationRequestDocument.model_json_schema(
        by_alias=True,
        mode="validation",
