"""Deterministic JSON Schema generation for PlanAuthorizationReport v0alpha1."""
...
SCHEMA_ID = PLAN_AUTHORIZATION_REPORT_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = PlanAuthorizationReport.model_json_schema(
        by_alias=True,
        mode="serialization",
