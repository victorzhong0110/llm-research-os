"""JSON Schema generation for PlanAuthorizationEventRequest v0alpha1."""
...
SCHEMA_ID = PLAN_AUTHORIZATION_EVENT_REQUEST_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = PlanAuthorizationEventRequestDocument.model_json_schema(
        by_alias=True,
        mode="validation",
