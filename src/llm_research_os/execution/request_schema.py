"""Deterministic JSON Schema generation for SimulationRequest v0alpha1."""
...
SCHEMA_ID = SIMULATION_REQUEST_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = SimulationRequestDocument.model_json_schema(
        by_alias=True,
        mode="validation",
