"""JSON Schema generation for NativeProcessPreflightReport v0alpha1."""
...
SCHEMA_ID = NATIVE_PROCESS_PREFLIGHT_REPORT_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = NativeProcessPreflightReport.model_json_schema(
        by_alias=True,
        mode="serialization",
