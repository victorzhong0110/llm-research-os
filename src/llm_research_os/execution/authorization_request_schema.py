"""Deterministic JSON Schema generation for PlanAuthorizationRequest v0alpha1."""
...
SCHEMA_ID = PLAN_AUTHORIZATION_REQUEST_SCHEMA_ID


def build_schema() -> dict[str, Any]:
    generated = PlanAuthorizationRequestDocument.model_json_schema(
        by_alias=True,
        mode="validation",
