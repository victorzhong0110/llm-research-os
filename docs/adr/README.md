...
| [0045](0045-cpu-oci-container-runtime.md) | CPU OCIContainerRuntime with digest-pinned images | Accepted | Implemented; docker adapter, `execute.oci`, host-python helper unchanged; live engine optional; not GPU, not NativeProcessRuntime |
