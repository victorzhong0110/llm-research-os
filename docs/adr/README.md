...
| [0042](0042-m1-local-authorization-consume-and-closure.md) | M1 local authorization consume and numbered-slice closure | Accepted | Implemented; SimulatedRuntime consumes `{eventId, sequence}` on this EventStore; Issue #19 closed; #38 / #42 remain open |

M0 kernel proof closed 2026-09-03; see ADR-0037. ADR-0015 remainders (SQLite artifact index and persistent projections) are delivered by ADR-0041 as M1-0. E4 numbered M1 slices close with ADR-0042; the question channel remains Issue #42.
