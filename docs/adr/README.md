...
| [0064](0064-planning-and-implementation-ownership.md) | Planning and implementation ownership | Integrated in #84 | Planning assistant owns global guidance; implementers deliver scoped code and evidence; maintainer controls acceptance |
| [0065](0065-reviewed-native-execution-authority.md) | Reviewed native Python authority and platform boundary | R03 contract accepted; runner not implemented | Separate `execute.native` from prior helper/noop grants; explicit Linux/macOS trust and restriction enforcement |
