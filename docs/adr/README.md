...
| [0064](0064-planning-and-implementation-ownership.md) | Planning and implementation ownership | Proposed for integration in R01 | Planning assistant owns global guidance; implementers deliver scoped code and evidence; maintainer controls acceptance |
