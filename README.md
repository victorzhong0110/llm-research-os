...
| NativeProcessRuntime | M3 slices 1-3 in progress (ADR-0063/0064/0065): local restricted helper + pinned identity profile + SSH onboard pending-live with optional local page + pack-output hardening; SSH execution refused; #53 stays open |
